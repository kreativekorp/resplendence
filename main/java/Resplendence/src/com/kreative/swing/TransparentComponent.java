...
implements ComponentListener, WindowFocusListener {
	...
	public TransparentComponent(Window frame) {
		this.frame = frame;
		updateBackground();
	...
	public TransparentComponent(Window frame, LayoutManager lm) {
		setLayout(lm);
		this.frame = frame;
		updateBackground();
		frame.addComponentListener(this); 
	...
	public void windowGainedFocus(WindowEvent evt) { repaint(); }    
	public void windowLostFocus(WindowEvent evt) { repaint(); }
}
