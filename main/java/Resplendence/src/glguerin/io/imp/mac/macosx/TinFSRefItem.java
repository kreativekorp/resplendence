...
// 22Mar2006 GLG  add nativePrep() and endian-conforming code
// 31Mar2006 GLG  change to call TinAlias.hasAliasHand()
  ...
  extends FSRefItemX
{
	...
	*/
	...
	/**
	** Holds T if big-endian, F if little-endian.  Used in constructor as arg to applyBigEndian().
	** Assigned a value returned by a native method nativePrep(), in static initializer block.
	*/
	private static final boolean nativeEndian;
	...
	*/
	...
	{
		super();
		myInfo.applyBigEndian( nativeEndian );
	}
	...
	*/
	...
	informOfChange( int messageValue, boolean specifically )
	{
		...
		*/
		...
		changed( messageValue, specifically, targetRef );
...
// #### END OF CHANGE-SIGNAL CODE ####
	...
	*/
	private static synchronized native boolean
		nativePrep();
